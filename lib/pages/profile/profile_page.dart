      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(colors: [
                        const Color.fromARGB(255, 2, 138, 6).withOpacity(0.7),
                        const Color.fromARGB(255, 15, 114, 228).withOpacity(0.7)
                      ]),
                    ),
                  ),
                ),
                  ...
                  child: CircleAvatar(
                    ...
                    child: Hero(
                      ...
                      child: Image.asset(avatarImage,
                          height: Get.height * 0.18, width: Get.width * 0.18),
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      profileHeader(
                          Icons.person, 'Md. Ebrahim Rahman', Get.width * 0.45),
                      SizedBox(height: 10.h),
                      profileHeader(Icons.email, 'ebrahimrahman68@gmail.com',
                          Get.width * 0.60),
                      SizedBox(height: 10.h),
                      profileHeader(
                          PhosphorIcons.gift, '587 points', Get.width * 0.25),
                    ],
                  ),
                ),
              ],
            ...
            profileDetails(Icons.home, 'Daffodil International University'),
